...
#'     gzipped Esri ASCII grid to an object of class \link[sp]{SpatialPixelsDataFrame-class}. Use \link[walkalytics]{pixel_walktimes}
...
#'    an object of class \link[sp]{SpatialPixelsDataFrame-class}.
#'
